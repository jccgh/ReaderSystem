package com.liyunkun.readersystem.administrator.module.impl;
 ...
 */
public class IAdminDataImpl implements IAdminData{

    @Override
    public void saveData2Book(int classId, int totalCount, final IBookCallBack callBack) {
